...
- `hyperlocalise phrase init`
- `hyperlocalise phrase config validate --config .phrase.yml`
- `hyperlocalise phrase push --config .phrase.yml`
- `hyperlocalise phrase pull --config .phrase.yml`
- `hyperlocalise phrase locales list --config .phrase.yml`
...
See the [phrase commands](/cli/commands/phrase) reference for flags, token lookup, and the Strings CLI gap table.
